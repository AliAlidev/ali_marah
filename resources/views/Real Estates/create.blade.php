            ...
            <div class="card-body">
                ...
                <form id="main_data" method="post" action="/store-real-estate" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6" style="margin-top: 2%">
                                ...
                                <input class="form-control" name="address_latitude" id="address-latitude" value="0" readonly/>
                            </div>
                            <div class="col-md-6" style="margin-top: 2%">
                        ...
                        <div class="col-md-12" style="margin-top: 4%">
                            <div class="col-md-6">
                                ...
                                <ul class="list-group">
                                    @foreach ($periods as $period)
                                        <li class="list-group-item rent_type"><input type="checkbox" name="period"
                                                value="{{ $period->id }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="rent_value_id" class="form-control" type="number" value="0.0" name="rent_amount"
                                    disabled>
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        ...
                        <div class="col-md-12" style="margin-top: 4%;">
                            ...
                            <div class="input-group">
                                <div class="col-md-4">
                                    <input type="checkbox" value="غربي" name="direction[]" id="">&nbsp;غربي
                                </div>
                                <span class="input-group-btn" style="width:50px;"></span>
                                <div class="col-md-4">
                                    <input type="checkbox" name="direction[]" value="شرقي" id="">&nbsp;شرقي
                                </div>
                                <span class="input-group-btn" style="width:50px;"></span>
                                <div class="col-md-3"><input type="checkbox" value="شمالي" name="direction[]"
                                        id="">&nbsp;شمالي
                                </div>
                                <span class="input-group-btn" style="width:50px;"></span>
                                <div class="col-md-3"><input type="checkbox" value="جنوبي" name="direction[]"
                                        id="">&nbsp;جنوبي
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" style="margin-top: 4%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="chimney" value="1">&nbsp;نعم
                                <input type="radio" name="chimney" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="swimming_pool" value="1">&nbsp;نعم
                                <input type="radio" name="swimming_pool" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="elevator" value="1">&nbsp;نعم
                                <input type="radio" name="elevator" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="with_rocks" value="1">&nbsp;نعم
                                <input type="radio" name="with_rocks" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="staircase" value="1">&nbsp;نعم
                                <input type="radio" name="staircase" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="alternative_energy" value="1">&nbsp;نعم
                                <input type="radio" name="alternative_energy" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="Water_well" value="1">&nbsp;نعم
                                <input type="radio" name="Water_well" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="hangar" value="1">&nbsp;نعم
                                <input type="radio" name="hangar" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="lanes" value="1">&nbsp;نعم
                                <input type="radio" name="lanes" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 2%">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="workshop" value="1">&nbsp;نعم
                                <input type="radio" name="workshop" value="0" style="margin-right: 2%"
                                    checked>&nbsp;لا
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        <div class="col-md-12" style="margin-top: 4%">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="chalet_layout_number"
                                    id="chalet_layout_number">
                            </div>
                            <!-- <div class="col-md-4">
                        ...
                        <div class="col-md-12" style="margin-top: 1%">
                            <div class="col-md-4">
                                ...
                                <select id="others_id" class="form-control" name="others_id">
                                    <option value=""></option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="others_length_id" class="form-control" type="number"
                                    name="real_estate_length" disabled>
                            </div>
                            <div class="col-md-4">
                                <label for="">العرض</label>
                                <input id="others_width_id" class="form-control" type="number" name="real_estate_width"
                                    disabled>
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                        ...
                        <div class="col-md-12" style="margin-top: 2%">
                            <div class="col-md-6">
                                ...
                                <input type="file" value="" name="real_estate_images[]" class="form-control"
                                    multiple>
                            </div>
                        </div>
                        <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    ...
                    <div class="row" style="margin-top: 3%;">
                        <input id="create_btn" type="submit" class="btn btn-primary" value="ادخال">
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $('#add_room_btn').click(function() {
            ...
            if (type != '' && length != '' && width != '') {
                var row = '<tr><th scope="row">' + (rows_count) +
                    '</th><td><input name="type[]" type="text" class="form-control" value=' + type +
                    ' readonly></td><td><input name="length[]" type="text" class="form-control" value=' + length +
                    ' readonly></td><td><input name="width[]" type="text" class="form-control" value=' + width +
                    ' readonly></td></tr>';
